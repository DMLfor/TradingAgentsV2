...
class TestSendNotification:
    ...
    @patch("tdx_data.notify._send_dingtalk")
    ...
    @patch("tdx_data.notify._send_email")
    @patch("tdx_data.notify._send_dingtalk", side_effect=Exception("fail"))
...
class TestSendDingtalk:
    ...
    @patch("tdx_data.notify.requests.post")
    def test_send_dingtalk_success(self, mock_post):
        from tdx_data.notify import _send_dingtalk
        mock_resp = MagicMock()
...
class TestSendEmail:
    ...
    @patch("tdx_data.notify.smtplib.SMTP_SSL")
    def test_send_email_ssl(self, mock_smtp_cls):
        from tdx_data.notify import _send_email
    ...
    @patch("tdx_data.notify.smtplib.SMTP")
